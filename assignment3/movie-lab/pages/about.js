        ...
        <Container>
            ...
            <Card>
                <Card.Body>
                    ...
                    <Card.Text>
                        This starts off as an interesting serial killer mystery. The attacks are horrifically shown. The couple forced to be tied up and stabbed is probably the most memorable. However the movie turns into something deeper. This is not another serial killer movie like the endless TV shows that populate modern networks. It may not even be about the central characters. This is an immersive experience living with the serial killer always on the mind. The Zodiac killer is just out there in this world. Its fascinating in its dark undertones and the lack of flashiness.
                    </Card.Text>
